...
;(function (name, fun) {
    ...
    var load = {
        ...
        cache: true,
        cacheData: [],
        sync: function(param, fun, namespace) {
            if(namespace && !document.getElementsByClassName(namespace).length) {
                return false;
            }
        ...
        async: function(param, fun, namespace) {
            if(namespace && !document.getElementsByClassName(namespace).length) {
                return false;
            }
            var _this = this;
